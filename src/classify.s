...
classify:
    ...
    addi a0, x0, 0
    addi t2, x0, 0
    beqz t0, mul_loop_end_1
    beqz t1, mul_loop_end_1
mul_loop_1:
    bge t2, t1, mul_loop_end_1
    add a0, a0, t0
    addi t2, t2, 1
    j mul_loop_1
...
mul_loop_end_1:
    ...
    addi a1, x0, 0
    addi t2, x0, 0
    beqz t0, mul_loop_end_2
    beqz t1, mul_loop_end_2
mul_loop_2:
    bge t2, t1, mul_loop_end_2
    add a1, a1, t0
    addi t2, t2, 1
    j mul_loop_2
...
mul_loop_end_2:
    ...
    addi a0, x0, 0
    addi t2, x0, 0
    beqz t0, mul_loop_end_3
    beqz t1, mul_loop_end_3
mul_loop_3:
    bge t2, t1, mul_loop_end_3
    add a0, a0, t0
    addi t2, t2, 1
    j mul_loop_3
...
mul_loop_end_3:
   ...
   #  mul a1, t0, t1 # load length of array into second arg
    ...
    addi a1, x0, 0
    addi t2, x0, 0
    beqz t0, mul_loop_end_4
    beqz t1, mul_loop_end_4
mul_loop_4:
    bge t2, t1, mul_loop_end_4
    add a1, a1, t0
    addi t2, t2, 1
    j mul_loop_4
